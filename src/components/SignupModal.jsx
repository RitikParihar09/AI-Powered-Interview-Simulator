        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
                <div className="p-8">
                    ...
                    <p className="text-gray-500 mb-6">Join InterviewBuddy to save your progress.</p>
                ...
                <div className="bg-gray-50 px-8 py-4 text-center text-sm text-gray-600 border-t border-gray-100">
                    Already have an account? <button onClick={onSwitchToLogin} className="text-blue-600 font-semibold hover:underline">Log in</button>
